...
3. **Start the local development database** as well as Prisma Studio (to peek inside the dev db) and the Stripe CLI webhook listener (to make payments work) with `docker-compose`:
...
You can also visit http://localhost:5555 to see the Prisma Studio for your local development database.
